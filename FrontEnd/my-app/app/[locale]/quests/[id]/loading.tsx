export default function Loading() {
  return (
    <div className="mx-auto max-w-2xl animate-pulse rounded-lg border border-zinc-200 bg-white p-6 shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
      {/* Tags */}
      ...
      <div className="mb-4 space-y-2">
        ...
        <div className="h-7 w-1/2 rounded bg-zinc-200 dark:bg-zinc-800" />
      </div>
